...
import { PNG_STAKING_ID, PNG_VESTING_ID, ZERO_U64 } from '../../common/constant';
...
export class Staking {
  public config: IStakingConfig;
  private program: Program;
  private vestingProgram: Program;
  private stakingInfo: any;
  private owner: PublicKey;

  constructor(provider: Provider, config: IStakingConfig, stakingInfo: any, owner: PublicKey) {
    this.config = config;
